...
var UI = setupUI.call(Helpers);
UI.init();

var App = setupApp.call(Helpers, UI);
...
function setupUI() {
    ...
    function initUI() {
        ...
        $workEntrySubmit.on("click", setButtonOnClick);
        function setButtonOnClick(){
            debugger;
            submitNewWorkEntry.call(context);
        }
        //setButtonOnClick.call(context);
