...
//get api
var data = appConnector();
debugger;
var api = data[0].connector;
console.log(api[0]);
debugger;
api.init();
api.addProject("client features");
api.addProject("overhead");
api.addProject("backlog");
...
function appConnector() {
    ...
    var App = (function () {
        var api = {
            ...
            addWorkToProject: function (projectId, description, minutes) {
    ...
    var connector = function (hold) {
        return hold;
    };
    debugger;
    return [{'connector': connector(App)}];
